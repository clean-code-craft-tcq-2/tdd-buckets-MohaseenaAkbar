...
void Sort_Current_Samples(int* current_sample_arr,int NoOfSample)
{
  ...
  for (current_sample1 = 0 ; current_sample1 < NoOfSample - 1; current_sample1++)
  {
      for (current_sample2 = 0 ; current_sample2 < NoOfSample - current_sample1 - 1; current_sample2++)
      {
         if (current_sample_arr[current_sample2] > current_sample_arr[current_sample2+1]) /* For decreasing order use < */
         {
